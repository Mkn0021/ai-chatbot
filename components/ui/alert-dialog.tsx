...
function AlertDialogOverlay({
	...
	return (
		<AlertDialogPrimitive.Overlay
			...
			className={cn(
				"data-open:animate-in data-closed:animate-out data-closed:fade-out-0 data-open:fade-in-0 fixed inset-0 z-50 bg-black/80 duration-100 supports-backdrop-filter:backdrop-blur-xs dark:bg-white/10",
				className,
			)}
			{...props}
		/>
