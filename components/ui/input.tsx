	...
	return (
		<input
			...
			className={cn(
				...
				"rounded-[6px] border-[0.5px] bg-[#F2F2F2] focus-visible:ring-1 focus-visible:ring-offset-0 dark:border-white/10 dark:bg-white/5 dark:text-zinc-100 dark:placeholder:text-white/30 dark:focus-visible:border-white/20 dark:focus-visible:ring-white/10",
				className,
			)}
			{...props}
		/>
