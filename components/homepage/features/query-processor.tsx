...
export function QueryProcessor() {
    return (
        <Circle className="size-90 mask-b-from-30%">
            ...
            <IconBall className="top-5 right-1/2"><Database /></IconBall>
            <IconBall className="top-1/2 right-1/2 -translate-x-18 size-8"><Sparkles /></IconBall>
            <IconBall className="top-1/2 right-18 -translate-y-10 size-12"><FileCode /></IconBall>
            <IconBall className="bottom-20 right-12 size-8"><BarChart3 /></IconBall>
        </Circle>
    )
}
