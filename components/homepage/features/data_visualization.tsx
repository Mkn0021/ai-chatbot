...
export function DataVisualization() {
    return (
        <Terminal>
            <Graph />
            <NameIndicator name="Users Table" position="top-10 -left-10" variant="bottom" />
...
export function Graph() {
    return (
        <div className="absolute bottom-16 top-0 left-0 right-0 flex items-end justify-between gap-4 h-47.5">
...
export function Terminal({ children }: {
    ...
    return (
        <div className="bg-white mx-auto m-4 rounded-[18px_18px_0px_0px] border border-[#E1E1E1] p-2 max-w-72.5 w-full shadow-[0px_37px_10px_0px_rgba(0,0,0,0.00),0px_24px_10px_0px_rgba(0,0,0,0.01),0px_13px_8px_0px_rgba(0,0,0,0.02),0px_6px_6px_0px_rgba(0,0,0,0.03),0px_1px_3px_0px_rgba(0,0,0,0.04)]">
            <div className="flex gap-2 mb-8">
                <Circle variant="red" />
                <Circle variant="orange" />
                <Circle variant="green" />
            </div>
            <div className="relative mx-auto h-50 w-65">
                {children}
            </div>
        </div>
    )
